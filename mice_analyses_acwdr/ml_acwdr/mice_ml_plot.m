...
load('C:\Users\duodenum\Desktop\brain_stuff\mice_regularacw\ML_matlab_acwdr\mice_mlresults')
...
% saveas(gcf, 'ML_matlab_acwdr\mean_mice_roc.jpg')
% saveas(gcf, 'ML_matlab_acwdr\mean_mice_roc.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\mean_mice_roc.jpg', 'Resolution',600)
...
sgtitle("Folds")
% saveas(gcf, 'ML_matlab_acwdr\mean_mice_roc_allfolds.jpg')
% saveas(gcf, 'ML_matlab_acwdr\mean_mice_roc_allfolds.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\mean_mice_roc_allfolds.jpg', ...
    'Resolution', 600)
...
fontsize(gcf, 14, "points")
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_all.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\confusionmatrix_all.jpg', 'Resolution', 600)
...
ylabel('True Class')
saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_mean.fig')
saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_mean.jpg')
...
sgtitle("Folds")
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_allfolds.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\confusionmatrix_allfolds.jpg', 'Resolution', 600)
