...
addpath(genpath('C:\Users\duodenum\Desktop\brain_stuff\mice_regularacw\ML_matlab_acwdr'))
addpath(genpath('C:\Users\duodenum\Desktop\brain_stuff\misc'))

load('C:\Users\duodenum\Desktop\brain_stuff\mice_regularacw\ML_matlab_acwdr\humans\human_mlresults.mat')
...
% saveas(gcf, 'ML_matlab_acwdr\mean_human_roc.jpg')
% saveas(gcf, 'ML_matlab_acwdr\mean_human_roc.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\mean_human_roc.jpg', ...
    'Resolution', 600)
...
sgtitle("Folds")
% saveas(gcf, 'ML_matlab_acwdr\mean_human_roc_allfolds.jpg')
% saveas(gcf, 'ML_matlab_acwdr\mean_human_roc_allfolds.fig')
exportgraphics(gcf, 'ML_matlab_acwdr\mean_human_roc_allfolds.jpg', ...
    'Resolution', 600)
...
fontsize(gcf, 14, "points")
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_all_human.fig')
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_all_human.jpg')
exportgraphics(gcf, 'ML_matlab_acwdr\confusionmatrix_all_human.jpg', ...
    'Resolution', 600)
...
sgtitle("Folds")
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_allfolds_human.fig')
% saveas(gcf, 'ML_matlab_acwdr\confusionmatrix_allfolds_human.jpg')
exportgraphics(gcf, 'ML_matlab_acwdr\confusionmatrix_allfolds_human.jpg', ...
    'Resolution', 600)
