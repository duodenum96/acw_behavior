...
for i = 1:n_subjs
    ...
    acwdrs_other{i} = acw_windowed_loop_dr(data, fs, windowsize);
    disp(i + " / " + n_subjs)
    toc
end

save("other_acws_dr.mat", "acwdrs_other", "subjnames")