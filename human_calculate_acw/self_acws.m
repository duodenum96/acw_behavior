...
acw0s_self = cell(1, n_subjs);
acw50s_self = cell(1, n_subjs);
...
for i = 1:n_subjs
    ...
    [acw0s_self{i}, acw50s_self{i}] = acw_windowed_loop(data, fs, windowsize);
    disp(i + " / " + n_subjs)
    toc
end

save("self_acws.mat", "acw50s_self", "acw0s_self", "subjnames")